...
ValorCaracteristica.belongsTo(CaracteristicaGenetica, { foreignKey: 'caracteristicaGeneticaId' });
...
const syncDatabase = async () => {
  try {
    ...
    await sequelize.sync({ alter: true }); // alter: true intenta hacer cambios sin perder datos (para desarrollo) 
